...
public class NyanStyle implements ModRenderStyle {
	...
	public void render(Theme theme, Glue glue, Mod mod, String name, int color, int x, int y, int x1, int y1) {
		GLUtils.glColor(0x80000000);
	    GLUtils.drawRect(glue.isRight() ? x : x + 2, y, glue.isRight() ? x1 - 2 : x1, y + 11);
		GLUtils.glColor(color);
	    GLUtils.drawRect(glue.isRight() ? x1 - 2 : x, y, glue.isRight() ? x1 : x + 2, y + 11);
